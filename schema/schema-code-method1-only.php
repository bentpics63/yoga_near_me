<?php
/**
 * Yoga Near Me - Studio Schema Markup (METHOD 1 ONLY - Recommended Start)
 * 
 * This version includes:
 * - METHOD 1: Filter Rank Math's JSON-LD output (both primary and backup filters)
 * - Custom YogaStudio schema output
 * 
 * We're skipping METHOD 2 (output buffering) for now - try this first!
 * 
 * INSTRUCTIONS:
 * 1. Copy ALL code below into your theme's functions.php
 ...
 * 
 * If this doesn't work, we can add METHOD 2 (output buffering) next.
 */
